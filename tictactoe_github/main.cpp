...
bool isAvailable(int row, int column)
{
   ...
   if (board[row][column] != PLAYER1_MARKER && board[row][column] != COMPUTER_MARKER )
   {
       return true;
   }
   else
...
bool gameOver()
{
    ...
    if(board[0][0]==COMPUTER_MARKER && board[1][0]==COMPUTER_MARKER && board[2][0]==COMPUTER_MARKER  )
        return true;

    if(board[0][1]==COMPUTER_MARKER  && board[1][1]==COMPUTER_MARKER  && board[2][1]==COMPUTER_MARKER )
        return true;

    if(board[0][2]==COMPUTER_MARKER  && board[1][2]==COMPUTER_MARKER  && board[2][2]==COMPUTER_MARKER  )
        return true;

    if(board[0][0]==COMPUTER_MARKER  && board[1][1]==COMPUTER_MARKER  && board[2][2]==COMPUTER_MARKER  )
        return true;

    if(board[2][0]==COMPUTER_MARKER  && board[1][1]==COMPUTER_MARKER  && board[0][2]==COMPUTER_MARKER  )
        return true;
    else return false;
